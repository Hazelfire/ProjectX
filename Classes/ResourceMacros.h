#define RESOURCE_FOLDER "data/"
	...
	#define UI_FOLDER RESOURCE_FOLDER "ui/"
		...
		#define DOWNLOAD_BASE_PACKAGE_FOLDER UI_FOLDER "download_base_package/"

			#define DOWNLOAD_BASE_PACKAGE_BACKGROUND DOWNLOAD_BASE_PACKAGE_FOLDER "background.png"
...
#define PACKAGES_FOLDER "pack/"
	
	#define PACKAGE_INDEX PACKAGES_FOLDER "packages.yml"